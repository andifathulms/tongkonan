...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  ...
  return {
    ...
    alternates: { canonical: pageUrl('sumber', locale, tradition(DEFAULT_TRADITION).slug) },
  }
}
...
export default function SumberMoved({ params }: { params: { locale: string } }) {
  const locale = isLocale(params.locale) ? params.locale : DEFAULT_LOCALE
  return <Moved locale={locale} route="sumber" />
}
