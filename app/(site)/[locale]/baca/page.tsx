...
export function generateMetadata({ params }: { params: { locale: string } }): Metadata {
  ...
  return {
    ...
    alternates: { canonical: pageUrl('baca', locale, tradition(DEFAULT_TRADITION).slug) },
  }
}
...
export default function BacaMoved({ params }: { params: { locale: string } }) {
  const locale = isLocale(params.locale) ? params.locale : DEFAULT_LOCALE
  return <Moved locale={locale} route="baca" />
}
