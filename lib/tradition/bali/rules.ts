...
export const DIMS = {
  ...
  deckDepthUnits: dim(2, 'count', 'interpolated', 'none', 'Dalamnya bale-bale, dalam hasta.', 'Depth of the sitting platform, in hasta.'),
  ...
  sakaSectionUnits: dim(1, 'count', 'interpolated', 'none', 'Sisi penampang saka, dalam musti. Ini ukuran batang, bukan ukuran tata letak, jadi tidak diberi pengurip — dan pemeriksaan modul menyatakan berapa panjang yang dikecualikannya karena alasan itu.', 'Section of a saka, in musti. This is a size of timber rather than a set-out dimension, so it takes no pengurip — and the module check states how many lengths it excludes for that reason.'),
