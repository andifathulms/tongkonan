/** The honai, assembled. Pure and deterministic, like the other twelve. */
...
import type { Bounds, DaniKinds, House, Layout, Part, Rules } from './types'
...
export type Timeline = CoreTimeline<DaniKinds>
export type TimelineEntry = CoreTimelineEntry<DaniKinds>
export type StageSpan = CoreStageSpan<DaniKinds>
