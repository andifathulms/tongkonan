/**
 * The pairs, assembled: the square, then post and little house together, one
 * pair for every clan.
 */
...
import type { Bounds, House, Layout, Part, Rules, NgadaKinds } from './types'
import { buildPairs, resolveLayout } from './frame'
import { PACK, dimsForLayout, normaliseRules } from './rules'

export { SEQUENCE_SECONDS, placedAt, progressAt } from '@/lib/core/assembly'

export type Timeline = CoreTimeline<NgadaKinds>
export type TimelineEntry = CoreTimelineEntry<NgadaKinds>
export type StageSpan = CoreStageSpan<NgadaKinds>
