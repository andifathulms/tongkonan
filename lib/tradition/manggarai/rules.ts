...
export const DIMS = {
  ...
  coneBelly: dim(0.055, 'ratio', 'interpolated', 'none', 'Seberapa jauh sisi kerucut menggembung ke luar dari garis lurus antara tanah dan puncak. Kecil, tetapi tanpa itu bentuknya menjadi kerucut geometris dan bukan atap yang dianyam.', 'How far the cone’s side bellies outward from a straight line between the ground and the apex. Small, but without it the form is a geometric cone rather than a thatched roof.'),
