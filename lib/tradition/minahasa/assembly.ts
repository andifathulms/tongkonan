/**
 * The woloan house, assembled — and the one house here that also has to come
 * apart. `checkCanBeUnbuilt` walks this same order backwards.
 */
...
import type { Bounds, House, Layout, MinahasaKinds, Part, Rules } from './types'
import { buildFrame, resolveLayout } from './frame'
import { buildRoof, buildShingles } from './roof'
import { PACK, dimsForLayout, normaliseRules } from './rules'

export { SEQUENCE_SECONDS, placedAt, progressAt } from '@/lib/core/assembly'

export type Timeline = CoreTimeline<MinahasaKinds>
export type TimelineEntry = CoreTimelineEntry<MinahasaKinds>
export type StageSpan = CoreStageSpan<MinahasaKinds>
