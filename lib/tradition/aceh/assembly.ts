/** The rumoh Aceh, assembled. Pure and deterministic, like the other nineteen. */
...
import type { Bounds, House, Layout, AcehKinds, Part, Rules } from './types'
import { buildFrame, resolveLayout } from './frame'
import { buildRoof, buildRumbia } from './roof'
import { PACK, dimsForLayout, normaliseRules } from './rules'

export { SEQUENCE_SECONDS, placedAt, progressAt } from '@/lib/core/assembly'

export type Timeline = CoreTimeline<AcehKinds>
export type TimelineEntry = CoreTimelineEntry<AcehKinds>
export type StageSpan = CoreStageSpan<AcehKinds>
...
export function buildHouse(rules: Rules): BuildResult {
  ...
  const parts = [...frame.parts, ...roof.parts, ...buildRumbia(layout)]
