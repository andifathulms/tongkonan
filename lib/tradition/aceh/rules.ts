 ...
 *
 * It was written as the *only* one, and the twenty-fifth entry proved that
 * wrong: a Madurese tanean puts its langgar at the west end for exactly this
 * reason. The claim is narrowed rather than deleted — see `ridgeRunsEastWest`
 * — because what is true of this house and of nothing else is that the whole
 * plan is turned by it.
 *
