/**
 * The balai, assembled: stones, posts of two lengths, three floors on two
 * levels, one roof over all of them.
 */
...
import type { Bounds, House, Layout, Part, Rules, RiauKinds } from './types'
import { buildBalai, resolveLayout } from './frame'
import { PACK, dimsForLayout, normaliseRules } from './rules'

export { SEQUENCE_SECONDS, placedAt, progressAt } from '@/lib/core/assembly'

export type Timeline = CoreTimeline<RiauKinds>
export type TimelineEntry = CoreTimelineEntry<RiauKinds>
export type StageSpan = CoreStageSpan<RiauKinds>
