...
export const DIMS = {
  ...
  yardWallHeight: dim(1.2, 'm', 'interpolated', 'none', 'Tinggi tembok pekarangan, dengan pintu masuk di muka. Tembok rendah agar tidak menutupi rumah dari luar; tingginya penetapan penulis.', 'Height of the yard wall, with the entrance in the front. Low enough not to hide the house from outside; the height is the author’s.'),
  yardWallThickness: dim(0.22, 'm', 'interpolated', 'none', 'Tebal tembok itu.', 'Thickness of that wall.'),
