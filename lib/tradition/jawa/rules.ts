...
export const DIMS = {
  /* the plan */
  guruSpan: dim(3.2, 'm', 'interpolated', 'none', 'Jarak antar soko guru, kedua arah. Persegi ini adalah pusat rumah, dan seluruh denah tumbuh keluar darinya.', 'Spacing between the soko guru, both ways. This square is the centre of the house, and the whole plan grows outward from it.'),
  ringStep: dim(2.0, 'm', 'interpolated', 'none', 'Jarak tiap cincin tiang di luar cincin di dalamnya.', 'How far each ring of pillars stands outside the one within it.'),
  ...
  ringDrop: dim(0.75, 'm', 'interpolated', 'none', 'Berkurangnya tinggi tiap cincin tiang di luar cincin di dalamnya; inilah yang membuat atap berjenjang.', 'How much shorter each ring of pillars is than the one within it; this is what steps the roof.'),
