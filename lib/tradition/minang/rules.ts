...
export const DIMS = {
  ...
  gonjongReach: dim(0.45, 'ratio', 'interpolated', 'none', 'Sejauh mana ke dalam badan rumah atap mulai terangkat, sebagai bagian dari setengah panjangnya. Lengkungan itu perlu jarak: bila hanya terjadi pada julur di ujung, gonjong menjadi layar segitiga yang ditempelkan, bukan atap yang menggulung naik.', 'How far back into the body the roof begins to lift, as a share of its half-length. The sweep needs room: confined to the overhang at the end, a gonjong becomes a triangular sail stuck on rather than a roof rolling up into a point.'),
