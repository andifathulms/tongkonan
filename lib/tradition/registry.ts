/**
 * The two houses, as one list the app can walk.
 *
...
import { BUKITTINGGI, RANTEPAO, WAE_REBO, YOGYAKARTA } from '@/lib/solar/position'
...
export const TRADITION_KEYS = ['toraja', 'minang', 'jawa', 'manggarai'] as const
