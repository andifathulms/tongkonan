...
export const DIMS = {
  ...
  alangPlan: dim(3, 'm', 'interpolated', 'none', 'Sisi denah satu alang. Yang digambar hanyalah jejak denahnya di tanah: sebuah alang adalah bangunan tersendiri dan bangunan yang tidak dimodelkan di sini tidak akan didirikan dari terkaan.', 'Plan side of one alang. Only its footprint on the ground is drawn: an alang is a building in its own right, and a building this project does not model will not be raised from a guess.'),
  alangFloorY: dim(1.9, 'm', 'interpolated', 'none', 'Tinggi lantai alang di atas tanah. Sebuah alang berdiri di atas enam tiang bulat licin agar tikus tidak dapat memanjatnya; yang dimodelkan di sini hanya massanya, dan setiap ukurannya penetapan penulis.', 'Height of the alang floor above the ground. An alang stands on six smooth round posts a rat cannot climb; only its massing is modelled here, and every figure is the author’s.'),
  alangBodyHeight: dim(1.4, 'm', 'interpolated', 'none', 'Tinggi badan alang di atas lantainya.', 'Height of the alang body above its floor.'),
  alangRoofRise: dim(2.9, 'm', 'interpolated', 'none', 'Tinggi bubungan alang di atas badannya. Atap alang melengkung seperti atap tongkonan; massa yang digambar di sini adalah pelana lurus dan bukan lengkungnya.', 'Rise of the alang ridge above its body. An alang’s roof is swept like the tongkonan’s; the massing drawn here is a straight gable and not that curve.'),
  alangPostWidth: dim(0.32, 'm', 'interpolated', 'none', 'Diameter tiang alang.', 'Diameter of an alang post.'),
  alangEave: dim(1.15, 'm', 'interpolated', 'none', 'Tritisan atap alang di luar badannya, pada massa yang digambar di sini.', 'Overhang of the alang roof beyond its body, on the massing drawn here.'),
