/**
 * The Toraja house, assembled.
 *
 * `buildHouse` is the whole public surface of this generator. It is pure and
 ...
 *
 * The ordering, the bounds and the timeline are all generic and live in
 * `lib/core/assembly.ts`; what is left here is the one thing that is not,
 * which is which builders run and in what order their parts are collected.
 */
...
import type { Bounds, House, Layout, Part, Rules, TorajaKinds } from './types'
...
export type Timeline = CoreTimeline<TorajaKinds>
export type TimelineEntry = CoreTimelineEntry<TorajaKinds>
export type StageSpan = CoreStageSpan<TorajaKinds>
