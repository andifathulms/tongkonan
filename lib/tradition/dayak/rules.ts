...
export const DIMS = {
  ...
  riverWidth: dim(70, 'm', 'interpolated', 'none', 'Lebar air yang digambar di muka rumah. Cukup lebar untuk melewati tepi gambar, karena sungai Kalimantan tidak berakhir beberapa meter dari rumah dan sebuah kolam berbentuk persegi akan menyatakan bahwa ia berakhir.', 'Width of the water drawn in front of the house. Wide enough to run past the edge of the drawing, because a Bornean river does not stop a few metres from the house and a rectangular pond would say that it does.'),
  waterSheet: dim(0.08, 'm', 'interpolated', 'none', 'Tebal lembar air pada model. Air di sini adalah permukaan tuang setebal beberapa sentimeter di atas tanah, bukan sungai yang digali ke dalamnya: tanah pada model ini satu bidang datar, dan menenggelamkan air di bawahnya berarti menyembunyikannya sama sekali.', 'Thickness of the water sheet on the model. The water here is a poured surface a few centimetres proud of the ground rather than a river cut into it: the ground in this model is one flat plane, and sinking the water below it hides the water completely.'),
