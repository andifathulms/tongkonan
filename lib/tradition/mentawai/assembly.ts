/**
 * The uma, assembled: stones, posts, a floor meant to spring, one roof over
 * every household under it.
 */
...
import type { Bounds, House, Layout, Part, Rules, MentawaiKinds } from './types'
import { buildUma, resolveLayout } from './frame'
import { PACK, dimsForLayout, normaliseRules } from './rules'

export { SEQUENCE_SECONDS, placedAt, progressAt } from '@/lib/core/assembly'

export type Timeline = CoreTimeline<MentawaiKinds>
export type TimelineEntry = CoreTimelineEntry<MentawaiKinds>
export type StageSpan = CoreStageSpan<MentawaiKinds>
