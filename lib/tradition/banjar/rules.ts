...
export const DIMS = {
  ...
  riverWidth: dim(60, 'm', 'interpolated', 'none', 'Lebar air yang digambar di muka pelataran, cukup untuk melewati tepi gambar. Sungai Barito jauh lebih lebar daripada apa pun yang muat dalam model.', 'Width of the water drawn in front of the platform, enough to run past the edge of the drawing. The Barito is far wider than anything that fits in the model.'),
