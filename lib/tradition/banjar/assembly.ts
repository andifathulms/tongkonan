/** The Banjar house, assembled. Pure and deterministic, like the other thirteen. */
...
import type { BanjarKinds, Bounds, House, Layout, Part, Rules } from './types'
...
export type Timeline = CoreTimeline<BanjarKinds>
export type TimelineEntry = CoreTimelineEntry<BanjarKinds>
export type StageSpan = CoreStageSpan<BanjarKinds>
