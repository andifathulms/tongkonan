/** The kariwari, assembled. Pure and deterministic, like the other fifteen. */
...
import type { Bounds, House, Layout, TobatiKinds, Part, Rules } from './types'
...
export type Timeline = CoreTimeline<TobatiKinds>
export type TimelineEntry = CoreTimelineEntry<TobatiKinds>
export type StageSpan = CoreStageSpan<TobatiKinds>
