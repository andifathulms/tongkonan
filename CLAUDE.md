...
- Provenance, kept separate and never averaged: tongkonan 0 measured / 7 canon / 46 interpolated (87%); rumah gadang 0 / 8 / 48 (86%); joglo 0 / 8 / 44 (85%); mbaru niang 0 / 8 / 38 (83%). All four are 100% interpolated by part. **Four houses and still no survey.** The bar has not moved and no further tradition will move it; only a measured drawing will. The second house did not improve the number and was never going to.
