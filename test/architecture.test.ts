...
describe('the core is tradition-neutral', () => {
  ...
  it('names no tradition-specific part, stage or material', () => {
    const forbidden = [
      ...
      'malige', 'buton', 'wolio', 'baubau', 'baji',
      'ngadhu', 'bhaga', 'ngada', 'nua', 'sa’o', 'ture', 'bena',
      'ume kbubu', 'kbubu', 'lopo', 'atoni', 'para', 'soe',
      'sudung', 'melangun', 'rimba', 'kubu', 'duabelas',
      'jaraik', 'rimata', 'turuk', 'mentawai', 'siberut',
      'ammu', 'hawu', 'duru', 'lontar', 'gewang', 'seba',
